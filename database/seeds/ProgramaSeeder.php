      ...
      $faker = Faker\Factory::create();
         ...
         $programa = [
           [
               ...
               'descripcion' => 'Necesario para distinguir entre evento y funcion'
           ],
           [
               'titulo' => 'Docs&Tonic',
               'poster' => $faker->image(storage_path('../public/uploads'), $width=100, $height=100, 'cats', true, true, 'Faker'),
               'descripcion' => 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget
